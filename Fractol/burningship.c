...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/10/03 15:47:54 by jjory-ca          #+#    #+#             */
/*   Updated: 2019/10/07 15:23:11 by jjory-ca         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void			fcalculating(t_data *data, t_pixels *pix, t_picture *pic)
{
	...
	{
		tmp = pix->zx;
		pix->zx = fabs(pix->zx * pix->zx - pix->zy * pix->zy + pix->cx);
		pix->zy = fabs(2 * tmp * pix->zy + pix->cy);
		i++;
	}
